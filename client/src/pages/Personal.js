    ...
    <>
      ...
      <p className='ls2 lh6 bs5 ts4'>
        <em className='emphasis'>
          &lt; fakesearch &gt;('https://fakesearch.link'이하 'fakesearch')
        </em>
      ...
      <p className='ls2'>
        ...
        <em className='emphasis'>1</em>월 <em className='emphasis'>15</em>부터
        적용됩니다.
      </p>
      <br />
      <p className='lh6 bs4'>
      ...
      <p className='lh6 bs4'>
        ...
        <br />
        <br />① <em className='emphasis'>&lt; fakesearch &gt;</em>은(는) 법령에
      ...
      <p className='ls2'>
        <br />
        <br />① 정보주체는 fakesearch에 대해 언제든지 개인정보
        열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
      </p>
      <p className='sub_p'>
        ② 제1항에 따른 권리 행사는fakesearch에 대해 「개인정보 보호법」 시행령
        제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
        있으며 fakesearch은(는) 이에 대해 지체 없이 조치하겠습니다.
      </p>
      <p className='sub_p'>
      ...
      <p className='sub_p'>
        ⑥ fakesearch은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
      ...
      <p className='lh6 bs4'>
        ...
        <br />
        <br /> ① <em className='emphasis'>&lt; fakesearch &gt;</em>은(는) 다음의
        개인정보 항목을 처리하고 있습니다.
      </p>
      <ul className='list_indent2 mgt10'>
        <li className='tt'>1&lt; 홈페이지 회원가입 및 관리 &gt;</li>
      ...
      <p className='ls2'>
        <em className='emphasis'>
          <br />① &lt; fakesearch &gt; 은(는) 개인정보 보유기간의 경과, 처리목적
          ...
          <br />
          1. 파기절차
          <br /> &lt; fakesearch &gt; 은(는) 파기 사유가 발생한 개인정보를
          선정하고, &lt; fakesearch &gt; 의 개인정보 보호책임자의 승인을 받아
          개인정보를 파기합니다.
          <br />
        </em>
      </p>
      ...
      <em className='emphasis'>
        ...
        <p className='sub_p mgt10'>
          1. 해킹 등에 대비한 기술적 대책
          <br /> &lt;<em className='emphasis'>fakesearch</em>&gt;('
          <em className='emphasis'>fakesearch</em>')은 해킹이나 컴퓨터 바이러스
        ...
        <p className='ls2'>
          <br />
          <br />① fakesearch 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기
        ...
        <p className='sub_p mgt10'>
          {' '}
          ① <span className='colorLightBlue'>fakesearch</span> 은(는) 개인정보
        ...
        <ul className='list_indent2 mgt10'>
          ...
          <li>직책 :개인</li>
          <li>직급 :개인</li>
          <li>연락처 :01071584204, bbaa3218@gmail.com, </li>
        </ul>
        <p className='sub_p'>※ 개인정보 보호 담당부서로 연결됩니다.</p>
        <p> </p>
        <p className='sub_p'>
          ② 정보주체께서는 fakesearch 의 서비스(또는 사업)을 이용하시면서 발생한
          모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
          개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. fakesearch
        ...
        <p className='sub_p mgt30'>
          <strong>
            ...
            <br />
            &lt; fakesearch &gt;은(는) 정보주체의 개인정보 열람청구가 신속하게
            처리되도록 노력하겠습니다.{' '}
          </strong>
        </p>
        <br />
        ...
        <p />
        <p className='sub_p'>
          ① 이 개인정보처리방침은 2022년 1월 15부터 적용됩니다.
        </p>
        <p className='sub_p' />
        <p className='sub_p' />
        <p />
